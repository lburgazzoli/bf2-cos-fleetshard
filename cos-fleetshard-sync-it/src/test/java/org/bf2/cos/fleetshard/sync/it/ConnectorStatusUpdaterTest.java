    ...
    void statusIsUpdated() {
        ...
        final ManagedConnector connector = new ManagedConnectorBuilder()
            .withMetadata(new ObjectMetaBuilder()
                ...
                .addToLabels("my.cos.bf2.org/version", "1")
                .addToAnnotations("connector.mgmt.bf2.org/organization", "foo")
                .addToAnnotations("connector.mgmt.bf2.org/connector.tier", "10")
                .build())
    ...
    public static class Profile extends SyncTestProfile {
        ...
        public Map<String, String> getConfigOverrides() {
            return Map.of(
                ...
                "cos.metrics.recorder.tags.labels[0]", "my.cos.bf2.org/version",
                "cos.metrics.recorder.tags.annotations[0]", "connector.mgmt.bf2.org/organization",
                "cos.metrics.recorder.tags.annotations[1]", "connector.mgmt.bf2.org/connector.tier");
        }
